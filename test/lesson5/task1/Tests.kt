...
class Tests {
    ...
    fun bestLongJump() {
        ...
        assertEquals(747963129, bestLongJump("% % 0 0 500763914    747963129"))
    ...
    fun bestHighJump() {
        ...
        assertEquals(-1, bestHighJump("230 +60 +% 70 +"))
    }
    ...
    fun firstDuplicateIndex() {
        ...
        assertEquals(0, firstDuplicateIndex("В в школу"))
    }
    ...
    fun fromRoman() {
        ...
        assertEquals(-1, fromRoman("P\$.t\\\\F%Z]4frL^OY"))
    }
